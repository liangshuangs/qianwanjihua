 ...
 * @LastEditTime: 2022-09-07 17:13:50
...
const Multirising = (props) => {
    ...
    return (
        <div>
            ...
            />
            <EchartModal type="multirising" closeEchartModal={closeEchartModal} record={record} echartData={echartData} rowData={data} visible={isModalVisible}/>
        </div>
    )
};
